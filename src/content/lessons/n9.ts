...
export const LESSONS_N9: Lesson[] = [
  ...
  },
  {
    ...
    blocks: [
      ...
      {
        kind: 'compare',
        promptKey: 'lesson.n9-l2.compare.prompt',
        correctIndex: 0,
        resultCorrectKey: 'lesson.n9-l2.compare.resultCorrect',
        resultIncorrectKey: 'lesson.n9-l2.compare.resultIncorrect',
        options: [
          {
            width: WIDTH,
            height: HEIGHT,
  ...
  },
  {
    ...
    proverbKey: 'lesson.n9-l3.proverb',
    blocks: [
