...
export const LESSONS_N7: Lesson[] = [
  ...
  },
  {
    ...
    blocks: [
      ...
      {
        kind: 'compare',
        promptKey: 'lesson.n7-l2.compare.prompt',
        correctIndex: 1,
        resultCorrectKey: 'lesson.n7-l2.compare.resultCorrect',
        resultIncorrectKey: 'lesson.n7-l2.compare.resultIncorrect',
        options: [
          {
            width: WIDTH,
            height: HEIGHT,
  ...
  },
  {
    ...
    blocks: [
      ...
      {
        kind: 'compare',
        promptKey: 'lesson.n7-l3.compare.prompt',
        correctIndex: 0,
        resultCorrectKey: 'lesson.n7-l3.compare.resultCorrect',
        resultIncorrectKey: 'lesson.n7-l3.compare.resultIncorrect',
        options: [
          {
            width: WIDTH,
            height: HEIGHT,
